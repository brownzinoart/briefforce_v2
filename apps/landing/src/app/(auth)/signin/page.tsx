            ...
            <Card className="p-8 border-2 border-blue-500 bg-gradient-to-br from-blue-50 to-purple-50 relative overflow-hidden">
              ...
              <div className="text-center">
                ...
                <p className="text-gray-600 mb-6 leading-relaxed">
                  Experience BriefForce in action with our interactive demo. See exactly how we transform chaotic client inputs into polished briefs in minutes.
                </p>
            ...
            <Card className="p-8 border-2 border-gray-200 hover:border-gray-300 transition-colors">
              <div className="text-center">
                ...
                <p className="text-gray-600 mb-6">
                  Already have a BriefForce account? Sign in to access your briefs, team, and settings.
                </p>

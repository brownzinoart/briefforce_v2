        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl text-gray-600">
              See how much time and budget BriefForce saves pharma marketing teams
            </p>
          </motion.div>
          ...
          <Card className="p-8 border-2 border-blue-200 bg-gradient-to-br from-blue-50 to-purple-50">
            <div className="grid md:grid-cols-2 gap-8">
              ...
              <div>
                <h3 className="text-xl font-semibold text-gray-900 mb-6">With AI-Powered BriefForce</h3>
                <div className="space-y-4">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div className="md:col-span-2">
              <h3 className="text-2xl font-bold mb-4">BriefForce</h3>
          ...
          <div className="border-t border-gray-800 pt-8 mt-8">
            <div className="flex flex-col md:flex-row justify-between items-center">
              <div className="text-sm text-gray-500 mb-4 md:mb-0">
                © 2025 BriefForce. All rights reserved.
              </div>
